...
W⋆-algebra M             — spectral projections / measurable structure (NormalState.lean)
...
neither Mathlib nor this development has yet (see `NormalState.lean`'s honesty note on the same
