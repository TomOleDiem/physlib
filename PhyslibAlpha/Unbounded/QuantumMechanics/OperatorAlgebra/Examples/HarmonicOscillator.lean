...
/-- The full essential-self-adjointness spectral data of the harmonic oscillator
Hamiltonian. -/
...
/-- The unitary group generated by the harmonic oscillator Hamiltonian's self-adjoint
closure. -/
