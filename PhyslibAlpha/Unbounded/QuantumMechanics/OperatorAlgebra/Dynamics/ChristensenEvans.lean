...
theorem isChristensenEvansGenerator_of_completelyPositiveShift
    (L : A →L[ℂ] A) (hL1 : L 1 = 0)
...
theorem map_eq_christensenEvans_of_isChristensenEvansGenerator
...
theorem isChristensenEvansGenerator_of_hasCompletelyPositiveShift
