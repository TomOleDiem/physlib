...
/-!
# Weak-operator spectral measures (part 1 of 2)

Split out of `WeakSpectralMeasure.lean` to stay under the file-length style limit; see
`WeakSpectralMeasure.lean` for the full module overview. This part defines `WOTSpectralMeasure`
and covers its basic algebra through the bounded spectral integral's uniform-approximation
construction.
-/
