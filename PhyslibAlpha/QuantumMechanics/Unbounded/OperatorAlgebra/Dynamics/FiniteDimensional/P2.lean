...
/-!
# Finite-dimensional GKSL algebra (part 2 of 2)

Continuation of `FiniteDimensional/Part1.lean`; see `FiniteDimensional.lean` for the full module
overview. This part covers the conditionally-completely-positive generator characterization and
the Choi-compression argument.
-/
